                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    decoration: const InputDecoration(
                      labelText: "Is this place YIYO right now?",
                    ...
                    onChanged: (value) {
                      if (value != null) {
                        setModalState(() => yiyoStatus = value);
                      }
                    },
                  ),
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    onChanged: (value) {
                      if (value != null) {
                        setModalState(() => crowdLevel = value);
                      }
                    },
                  ),
                  const SizedBox(height: 12),
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    onChanged: (value) {
                      if (value != null) {
                        setModalState(() => safetyLevel = value);
                      }
                    },
                  ),
                  const SizedBox(height: 12),
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: const [
                      DropdownMenuItem(value: "Amapiano", child: Text("Amapiano")),
                      DropdownMenuItem(value: "Afrobeat", child: Text("Afrobeat")),
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: const [
                      DropdownMenuItem(value: "No queue", child: Text("No queue")),
                      DropdownMenuItem(value: "Short", child: Text("Short")),
                      DropdownMenuItem(value: "Long", child: Text("Long")),
                    ],
                    onChanged: (value) {
                      if (value != null) {
                        setModalState(() => queueLength = value);
                      }
                    },
                  ),
                  const SizedBox(height: 12),
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    onChanged: (value) {
                      if (value != null) {
                        setModalState(() => parkingAvailability = value);
                      }
                    },
                  ),
                  const SizedBox(height: 12),
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: const [
                      DropdownMenuItem(value: "Safe", child: Text("Safe")),
                      DropdownMenuItem(value: "Okay", child: Text("Okay")),
                      DropdownMenuItem(value: "Risky", child: Text("Risky")),
                      DropdownMenuItem(value: "Unsafe", child: Text("Unsafe")),
                    ],
                    onChanged: (value) {
                      if (value != null) {
                        setModalState(() => parkingSafety = value);
                      }
                    },
                  ),
                  const SizedBox(height: 12),
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(
                      ...
                      border: OutlineInputBorder(),
                      hintText: "Guards visible? Street parking? Valet?",
                    ),
                  ),
                  const SizedBox(height: 12),
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(
                      ...
                      border: OutlineInputBorder(),
                      hintText: "How’s the vibe right now?",
                    ),
                  ),
